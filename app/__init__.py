...
class MainWindow(QMainWindow):
    ...
    def setup_info(self, index):
        ...
        modeling_text_out, modeling_func = self.engine.get_text_and_func_modeling_output(self.engine.get_dataset(index))
        self.ui.modeling_func.setPixmap(modeling_func)
        self.ui.text_output.setText(modeling_text_out)